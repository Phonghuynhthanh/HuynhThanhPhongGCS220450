...
from update_video import UpdateVideos  # Import UpdateVideos class
...
def update_videos_clicked():
    ...
    UpdateVideos(tk.Toplevel(window))  # Assumes UpdateVideos is defined in update_videos module
